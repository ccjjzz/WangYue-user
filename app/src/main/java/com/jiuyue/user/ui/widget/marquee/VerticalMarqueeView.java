package com.jiuyue.user.ui.widget.marquee;
...
public class VerticalMarqueeView extends ViewFlipper {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.marqueeViewStyle, 0, 0);
        ...
        if (typedArray.hasValue(R.styleable.marqueeViewStyle_mvTextSize)) {
            ...
            textSize = Dp2px.px2sp(context, textSize);
        }
        ...
        boolean hasSetDirection = typedArray.hasValue(R.styleable.marqueeViewStyle_mvDirection);
    ...
    private void startWithFixedWidth(String notice, @AnimRes int inAnimResId, @AnimRes int outAnimResID) {
        ...
        int width = Dp2px.px2dp(getWidth());
        if (width == 0) {
        ...
        if (noticeLength <= limit) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                int endIndex = (Math.min((i + 1) * limit, noticeLength));
