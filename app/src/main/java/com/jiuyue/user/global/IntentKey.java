...
public class IntentKey {
    /*****************************公共*******************************/
    public static final String WEB_TITLE = "INTENT_WEB_TITLE";
    public static final String WEB_URL = "INTENT_WEB_URL";
    public static final String WEB_DATA = "INTENT_WEB_DATA";
    ...
    public static final String SERVICE_CITY_BRAN = "INTENT_SERVICE_CITY_BRAN";
