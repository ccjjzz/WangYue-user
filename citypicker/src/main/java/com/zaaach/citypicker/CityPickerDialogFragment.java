...
//            mHotCities.add(new HotCity("北京", "北京", "010", "116.4039", "39.91521"));
//            mHotCities.add(new HotCity("上海", "上海", "021", "113.25903", "23.154516"));
//            mHotCities.add(new HotCity("广州", "广东", "020", "113.25903", "23.154516"));
//            mHotCities.add(new HotCity("深圳", "广东", "0755", "114.019806", "22.538687"));
//            mHotCities.add(new HotCity("天津", "天津", "022", "116.93846", "38.936523"));
//            mHotCities.add(new HotCity("杭州", "浙江", "0571", "120.28554", "30.31899"));
//            mHotCities.add(new HotCity("南京", "江苏", "025", "118.887375", "31.944262"));
//            mHotCities.add(new HotCity("成都", "四川", "028", "104.13486", "30.641531"));
//            mHotCities.add(new HotCity("武汉", "湖北", "027", "114.37016", "30.893826"));
        }
        //初始化定位城市，默认为空时会自动回调定位
        if (mLocatedCity == null) {
            mLocatedCity = new LocatedCity(getString(R.string.cp_locating), "未知", "0", "0.0", "0.0");
        ...
        if (mAllCities == null || mAllCities.isEmpty()) {
            ...
            dbManager.saveCities(mAllCities);
        }
        mAllCities.add(0, mLocatedCity);
        mAllCities.add(1, new HotCity("热门城市", "未知", "0", "0.0", "0.0"));
        mResults = mAllCities;
    }
