...
public class CustomNoticeMessageHolder extends MessageContentHolder {

    protected TextView msgBodyText;

    public CustomNoticeMessageHolder(View itemView) {
        super(itemView);
    ...
    public void layoutVariableViews(TUIMessageBean msg, int position) {
        if (!(msg instanceof CustomNoticeMessageBean)) {
            return;
        }
        CustomNoticeMessageBean textMessageBean = (CustomNoticeMessageBean) msg;
